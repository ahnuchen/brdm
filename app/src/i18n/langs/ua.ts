const ua = {
  message: {
    ...
    info_disabled:
      'Виняток при виконанні команди Info (можливо, було відключено), інформація про Redis не відображається',
    page_zoom: 'Масштаб сторінки',
    scan_disabled:
      'Виняток при виконанні команди Scan (можливо, було відключено), неможливо відобразити список ключів',
    ...
    clear_cache_tip:
      'Коли виникає проблема з клієнтом, ця операція видалить усі з\'єднання та конфігурації для відновлення клієнта',
    detail: 'деталь',
    separator_tip:
      'Розділювач дерева, встановлений на порожній, щоб вимкнути дерево та клавіші відображення як список',
