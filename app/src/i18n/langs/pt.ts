const pt = {
  message: {
    ...
    enter_to_exec:
      'Pressione Enter para comandos de execução, para cima e para baixo para alternar o histórico',
    pre_version: 'Versão',
    ...
    update_downloaded:
      'Download de atualização concluído, reinicie seu aplicativo por favor.\
    ...
    cluster_faq:
      'Selecione qualquer nó no cluster para preencher e outros nós serão identificados automaticamente.',
    redis_status: 'Informaçôes do Redis',
    confirm_flush_db: 'Confirme a exclusão de todas as chaves em db{db}?',
    flushdb: 'Flush DB',
    info_disabled:
      'Exceção de execução do comando de informação (pode ter sido desativado), as informações do redis não podem ser exibidas',
    page_zoom: 'Zoom da página',
    scan_disabled:
      'Exceção de execução do comando de scan (pode ter sido desativada), a lista de chaves não pode ser exibida',
    ...
    key_no_permission:
      'A permissão de leitura do arquivo expirou, selecione novamente o arquivo de chave manualmente',
    toggle_check_all: 'Selecionar tudo | Desmarcar tudo',
    select_lang: 'Selecione o idioma',
    clear_cache_tip:
      'Quando há um problema com o cliente, esta operação irá deletar todas as conexões e configurações para restaurar o cliente',
    detail: 'Detalhe',
    separator_tip:
      'O separador da visualização em árvore, definido como vazio para desativar a árvore e exibir as chaves como lista',
    confirm_modify_unvisible_content:
      'O conteúdo contém caracteres invisíveis, você pode editar com segurança no "Hex View". Se continuar a editar em "Text View" pode causar erros de codificação, quer continuar?',
  },
}
