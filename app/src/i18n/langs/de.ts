const de = {
  message: {
    ...
    retry_too_many_times:
      'Zu viele Versuche, die Verbindung wieder herzustellen. Bitte überprüfen Sie den Server-Status',
    ...
    cluster_faq:
      'Wählen Sie einen beliebigen Knoten im Cluster zum Ausfüllen aus, und andere Knoten werden automatisch identifiziert.',
    redis_status: 'Redis Info',
    confirm_flush_db: 'Bestätigen Sie, um alle Schlüssel in db ({db}) zu löschen ?',
    flushdb: 'Speichere Datenbank',
    info_disabled:
      'Info-Befehlsausführungsausnahme (kann deaktiviert worden sein), Redis-Info kann nicht angezeigt werden',
    page_zoom: 'Seite vergrößern',
    scan_disabled:
      'Ausnahme bei der Ausführung von Scan-Befehlen (kann deaktiviert worden sein), Schlüsselliste kann nicht angezeigt werden',
    key_type_not_support:
      'Die visuelle Anzeige wird für diesen Typ wird nicht unterstützt. Bitte benutzen Sie die Konsole.',
    ...
    key_no_permission:
      'Die Berechtigung zum Lesen von Dateien ist abgelaufen. Wählen Sie die Schlüsseldatei erneut manuell aus',
    ...
    detail: 'Detail',
    separator_tip:
      'Das Trennzeichen der Baumansicht wird auf leer gesetzt, um den Baum zu deaktivieren und Schlüssel als Liste anzuzeigen',
